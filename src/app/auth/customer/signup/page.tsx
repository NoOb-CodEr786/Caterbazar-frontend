...
import { Eye, EyeOff, ArrowLeft, Loader2, AlertCircle, Home } from "lucide-react";
import { useRouter } from "next/navigation";
import { userSignup, verifyOTP, resendOTP } from "@/api/user/auth.api";

export default function CaterBazarSignup() {
            ...
            <>
              <div className="mb-8">
                ...
                <p className="text-gray-600 text-sm">
                  Join CaterBazar to book caterers easily
                </p>
              </div>
              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <div className="w-20 px-4 py-3 border border-gray-300 rounded-lg bg-gray-50 flex items-center justify-center text-sm font-medium text-gray-700">
                      +91
                    </div>
                    <input
                      type="tel"
