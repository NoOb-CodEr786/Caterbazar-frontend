...
import { ArrowLeft, Loader2, AlertCircle, CheckCircle, Phone } from "lucide-react";
      ...
      >
        <div className="absolute inset-0 flex flex-col justify-end p-12 text-white">
          <div className="max-w-md">
            ...
            <div>
              <p className="font-semibold text-lg">CaterBazar Vendor Security</p>
              <p className="text-gray-300 text-sm">Your business account is safe with us</p>
            </div>
          </div>
        </div>
      </div>
