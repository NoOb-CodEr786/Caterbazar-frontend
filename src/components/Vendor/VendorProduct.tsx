  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="py-2 hidden sm:block">
        <div className="container mx-auto px-4 sm:px-6 py-2 sm:py-3">
          <div className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm overflow-x-auto hide-scrollbar">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-gray-700 whitespace-nowrap">{vendor.userId.fullName}</span>
          </div>
        </div>
      </div>
        ...
        <div className="grid lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
              ...
              <div className="flex items-start justify-between gap-3 mb-3 sm:mb-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1 sm:mb-2">
                    <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">{vendor.userId.fullName}</h1>
            ...
            <div className="bg-white rounded-lg sm:rounded-2xl p-4 sm:p-6 shadow-lg">
              <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-3 sm:mb-4">About {vendor.userId.fullName}</h2>
      ...
      <InquiryModal
        ...
        vendorName={vendor.userId.fullName}
      />
    </div>
  );
}